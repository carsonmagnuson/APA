...
def parse() -> argparse.Namespace:
  ...
  parser.add_argument('-s', '--specified', help='Use this if you already have a list of pre-selected ortholog NCBI IDs you would like to specify. Separate each ID with a comma, no spaces') ## for specifying your own list of orthologs 
